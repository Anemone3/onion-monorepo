  ...
  return (
    <article className="flex w-full items-center justify-between py-8">
      ...
      <div className="mr-3 flex items-center gap-8">
        <p className="font-semibold underline">Processing</p>
        <Button className="h-11 w-28 border border-gray-950 bg-white font-semibold text-gray-950 hover:text-white">
          View Item
        </Button>
      </div>
    </article>
